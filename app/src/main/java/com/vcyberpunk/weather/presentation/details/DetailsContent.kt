...
import com.vcyberpunk.weather.presentation.extensions.formattedFullDay
import com.vcyberpunk.weather.presentation.extensions.formattedShortDayOfWeek
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            IconButton(onClick = { onClickChangeFavouriteStatus() }) {
                ...
                Icon(
                    imageVector = icon,
                    contentDescription = stringResource(R.string.add_to_favourite_button_content_description),
                    tint = MaterialTheme.colorScheme.background
                )
            }
        }
    ...
    Column(
        ...
        Row(
            ...
            GlideImage(
                ...
                contentDescription = stringResource(R.string.condition_icon_content_description)
            )
        }
        Text(
